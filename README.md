...
该脚本还包含许多系统管理员和高级用户会喜欢的功能，例如强大的命令行界面、Windows 审核模式支持以及对其他 Windows 用户进行更改的能力。更多详情请参阅我们的 [Wiki](https://github.com/Raphire/Win11Debloat/wiki/)。
...
以下是 Win11Debloat 提供的主要功能和特性的概述。有关默认设置预设的更多信息，请参阅 [Wiki](https://github.com/Raphire/Win11Debloat/wiki/Default-Settings)。

> [!Tip]
> Win11Debloat 所做的所有更改都可以轻松恢复，几乎所有应用都可以通过 Microsoft Store 重新安装。有关如何恢复更改的完整指南，请点击[此处](https://github.com/Raphire/Win11Debloat/wiki/Reverting-Changes)。
...
- 禁用「查找我的设备」位置跟踪。
- 禁用锁屏上的「Windows 聚焦」以及提示和技巧。
- 禁用桌面「Windows 聚焦」背景选项。
...
- 选择[对其他用户应用更改](https://github.com/Raphire/Win11Debloat/wiki/Advanced-Features#running-as-another-user)，而不是当前登录的用户。
...
欢迎各种形式的贡献！请查看我们的[贡献指南](/.github/CONTRIBUTING.md)以获取详细的入门说明和最佳实践。
